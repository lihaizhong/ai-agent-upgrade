...
3. **学习导航** — 课程结束后展示选项：做练习题 / 学习下一课 / 返回课程列表
4. **练习题**（如选择）— 动态生成1道与课程相关的练习题，即时反馈
   - **⚠️ 如果练习题包含选择题，正确答案必须随机分布在A、B、C、D中**
5. **代码实现提示**（做完练习题后）— **主动提示**用户查看本课配套的Python代码实现，鼓励动手实践
6. **下一步导航** — 查看代码后或跳过代码，提示学习下一课 / 返回课程列表

**流程设计意图**：
- 学完理论 → 做练习巩固 → **主动引导**查看代码实现 → 再进入下一课
- 这样形成"学-练-实践"的完整闭环，而不是让用户自己从菜单中找代码
