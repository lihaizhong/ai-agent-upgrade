...
example:
    ...
    2. Create a file called greet.py with a greet(name) function in test_workspace
    3. Edit greet.py to add a docstring to the function in test_workspace
    4. Read greet.py to verify the edit worked in test_workspace
"""
...
# -- The dispatch map: {tool_name: hander} --
TOOL_HANDLERS = {
